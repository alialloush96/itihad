...
if(isset($_POST['check']))
{
    ...
    if ($result)
    {
        if (mysqli_num_rows($result) > 0) {
          echo '<script>alert("The Certificate is founded")</script>';
        }
        else
        {
          echo '<script>alert("The Certificate is not funded")</script>';
        }
      }
      else
      {
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-3 col-sm-12">
                                    <div class="logo">
                                        <a href="index.html"><img src="img/logo/logo.png" alt="Al Etihad"></a>
                                    </div>
                                </div>
                                <div class="col-md-9">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="breadcrumb-text">
                                    <h1 class="text-center">Check Your certificate</h1>
                                    ...
                                    <div class="form-container">
                                        <div class="box-select">
                                            <div class="select large">
                                                  <span class="certificate_text"> Enter Your Certificate Code Here :</span>
                                            </div>
                                            <div class="select small">
                                              <input type="text" name="code" placeholder="Your code" class="certificate_code">
                                            </div>
                                        </div>
                                        <button type="submit" name="check">Check Your Code</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="section-title-wrapper">
                                    <div class="section-title">
                                        ...
                                        <p>Read The Information Carefully</p>
                                    </div>
                                </div>
                            </div>
                        </div>
